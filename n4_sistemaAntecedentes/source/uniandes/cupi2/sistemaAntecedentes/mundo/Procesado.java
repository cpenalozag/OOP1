...
public class Procesado
{
    ...
    /**
     * a Crea un antecedente dada la información por parámetro y lo agrega a la lista de antecedentes del procesado. <br>
     ...
     * @param pAnhosCondena Los años de condena por el antecedente dado.
     ...
     * @throws Exception Si la gravedad del antecedente es GRAVE y la condena dada por parámetro es menor o igual a MAXIMO_ANHOS_CONDENA_LEVE o mayor a
