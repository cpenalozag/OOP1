...
public class Antecedente
{
     ...
     * @param pAnhosCondena La nueva condena.
     * @throws Exception Si la gravedad del antecedente es LEVE y la condena dada por parámetro es
     *  menor o igual a 0 o mayor a MAXIMO_ANHOS_CONDENA_LEVE.
     * @throws Exception Si la gravedad del antecedente es GRAVE y la condena dada por parámetro es
     *  menor o igual a MAXIMO_ANHOS_CONDENA_LEVE o mayor a MAXIMO_ANHOS_CONDENA_GRAVE.
     * @throws Exception Si la gravedad del antecedente es MUY_GRAVE y la condena dada por parámetro
     *  es menor a MINIMO_ANHOS_CONDENA_MUY_GRAVE.
     */
    public void cambiarCondena( int pAnhosCondena ) throws Exception
    {
    	if ( darGravedad().equals(LEVE) && ( pAnhosCondena <= 0 || pAnhosCondena > MAXIMO_ANHOS_CONDENA_LEVE ) )
    	{
    		throw new Exception ( "Por ser un antecedente de gravedad leve, la condena debe ser mayor a 0 años y menor o igual a " + MAXIMO_ANHOS_CONDENA_LEVE + " años." );
    	}
    	if ( darGravedad().equals(GRAVE) && ( pAnhosCondena <= MAXIMO_ANHOS_CONDENA_LEVE || pAnhosCondena > MAXIMO_ANHOS_CONDENA_GRAVE ) )
    	{
    	...
    	if ( darGravedad().equals(MUY_GRAVE) && pAnhosCondena < MINIMO_ANHOS_CONDENA_MUY_GRAVE )
    	{
