...
public class InterfazTienda extends JFrame
{
    ...
    public InterfazTienda( )
    {
        ...
        Producto p1 = new Producto( Producto.PAPELERIA, "Libreta", 5500.0, 44, 15 );
        Producto p2 = new Producto( Producto.SUPERMERCADO, "Leche", 2100.0, 25, 10 );
        Producto p3 = new Producto( Producto.DROGUERIA, "Aspirina", 2400.0, 13, 11 );
        Producto p4 = new Producto( Producto.SUPERMERCADO, "Jabon en polvo", 4200.0, 36, 8 );
