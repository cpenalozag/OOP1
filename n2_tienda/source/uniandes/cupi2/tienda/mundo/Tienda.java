...
public class Tienda
{
    ...
    public double promediarValorUnitario ( )
    {
    	return (p1.darValorUnitario() + p2.darValorUnitario() + p3.darValorUnitario() + p4.darValorUnitario()) / 4;
    }
    
    public int calcularCantidadEstantes ( )
    {
    	return ( p1.darCantidadBodega( ) + p2. darCantidadBodega( ) + p3.darCantidadBodega( ) + p4.darCantidadBodega( ) ) / 50; 
    ...
    {
    	Producto masCaro = p1;
    	double valorMas = p1.darValorUnitario();
    	
    	if (p2.darValorUnitario()>valorMas)
    	{
    		masCaro = p2;
    		valorMas= p2.darValorUnitario();
    	}
    	
    	if (p3.darValorUnitario()>valorMas)
    	{
    		masCaro = p3;
    		valorMas = p3.darValorUnitario();
    	}
    	
    	if (p4.darValorUnitario()>valorMas)
    	{
    		p4 = masCaro;
    		valorMas = p4.darValorUnitario();
    	}
    	
    	return masCaro.darNombre();
    }
    
    public void aumentarPreciosTodosProductos( )
    ...
    {
        return "El producto más caro de la tienda es: " + productoMasCaro ( );
    }
// para el ejercicio 1 es: return "El valor unitario promedio de los productos es: " + promediarValorUnitario( ) + " pesos.";
    /**
    ...
    {
        return "La cantidad de estantes necesaria es: " + calcularCantidadEstantes ( );
    }
